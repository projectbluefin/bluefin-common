FROM docker.io/library/golang:alpine@sha256:70b46548e42db77e0966aaf3619fd068734dc6c77584d526b91126504fd95816 AS umotd-build
RUN apk add git && \
...
FROM docker.io/library/golang:alpine@sha256:70b46548e42db77e0966aaf3619fd068734dc6c77584d526b91126504fd95816 AS uwelcome-build
RUN apk add git && \
