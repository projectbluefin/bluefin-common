...
## Current parity matrix — core pipeline repos

<!-- BEGIN GENERATED PARITY MATRIX -->

| Artifact | common | bluefin | bluefin-lts | dakota | actions | testsuite |
|---|---|---|---|---|---|---|
| AGENTS.md | yes | yes | yes | yes | yes | yes |
| pre-commit | yes | yes | yes | yes | yes | — |
| Lifecycle caller | — | yes | yes | yes | — | — |
| Renovate config | yes | yes | yes | yes | yes | yes |
| Skill router (docs/SKILL.md) | yes | yes | — | yes | yes | — |
| Skill catalog (index.json) | yes | — | — | — | — | — |
